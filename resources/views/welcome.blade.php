...
<main class="main">
    <div class="info-content">
        <h1 class="dark:text-white">Te damos las <span>Soluciones</span> a tus problemas</h1>
        <br>
        <p class="dark:text-white">¡Olvídate de las reparaciones costosas y tardadas! Nuestro sistema de suscripción y asistencia virtual te ofrece soluciones rápidas y económicas a tus problemas técnicos. ¡Únete a nuestra comunidad y soluciona tus problemas desde la comodidad de tu hogar!</p>
        <a download="" href="#">
            <br>
            <!-- <button class="download-cv" download="">Comienza ahora</button> -->
            <!-- <button header></button> -->
            <a href="{{ route('login')}}" class="download-cv   lg:px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 {{ request()->routeIs('login') ? 'text-sky-600 dark:text-white' : 'text-slate-400' }}">
                Comienza ahora
            </a>
        </a>
    </div>
    <!---<img src="./img/pexels-photo-1516680-removebg-preview.png" alt="">-->
    <!--<video src="./img/com.mp4" autoplay loop></video >-->
    <img src="./img/computer.svg" alt="">

    <svg class="i" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="619.4842" height="336.68123" viewBox="0 0 1019.4842 436.68123" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <path d="M105.002,663.39128,90.2579,608.62916l.69264-.18651a22.07516,22.07516,0,0,1,27.054,15.57522l.00037.00135L127.01,657.46609Z" transform="translate(-90.2579 -231.65939)" fill="#2f2e41" />
        <polygon points="117.278 420.254 103.054 409.91 136.185 350.121 157.179 365.388 117.278 420.254" fill="#ffb8b8" />
        <path d="M201.1368,668.34061,155.27068,634.9853l.42187-.58015a22.07517,22.07517,0,0,1,30.8348-4.87041l.00114.00082L214.54188,649.908Z" transform="translate(-90.2579 -231.65939)" fill="#2f2e41" />
        ...
        <rect x="137.51364" y="351.37595" width="21.61009" height="21.61009" transform="translate(-313.1754 254.44578) rotate(-86.18992)" fill="#e6e6e6" style="isolation:isolate" />
        <path d="M124.34354,362.13134l26.18282,1.74368-1.74369,26.18282-26.18282-1.74368Zm24.96862,2.80626-23.90605-1.59206-1.59206,23.906,23.90605,1.59206Z" transform="translate(-90.2579 -231.65939)" fill="#ccc" />
        <rect x="241.00867" y="288.77184" width="21.61009" height="21.61009" transform="translate(-147.57238 -172.07462) rotate(-12.12675)" fill="#e6e6e6" style="isolation:isolate" />
        <path d="M245.27842,276.50957l5.51255,25.65526-25.65526,5.51254-5.51254-25.65526Zm4.15743,24.7795-5.0332-23.42436-23.42437,5.03319,5.03319,23.42438Z" transform="translate(-90.2579 -231.65939)" fill="#ccc" />
        <rect x="226.60299" y="392.67408" width="21.61008" height="21.61009" transform="translate(-301.94557 39.64172) rotate(-43.12712)" fill="#e6e6e6" style="isolation:isolate" />
        ...
        <rect x="888.40147" y="52.28163" width="24.49176" height="24.49173" fill="#6c63ff" />
...
<div class="pages">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fill-opacity="1" d="M0,192L48,197.3C96,203,192,213,288,234.7C384,256,480,288,576,288C672,288,768,256,864,240C960,224,1056,224,1152,213.3C1248,203,1344,181,1392,170.7L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
</div>
</div>
<body>
